...
**[Webpack Project]** is a basic website built using webpack
...
2. - [ ] Run `https://github.com/kennedyowusu/awesome-books/tree/build-awesome-books.git`
3. - [ ] cd awesome-books
4. - [ ] Open in the IDE
...
Feel free to check the [issues page]((https://github.com/kennedyowusu/awesome-books/issues)).
